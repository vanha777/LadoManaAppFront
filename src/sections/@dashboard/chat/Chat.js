...
export default function Chat() {
  ...
  const { contacts, recipients, participants, activeConversationId, conversations, ccData } = useSelector(
    (state) => state.chat
  );
  console.log(ccData)
  ...
  return (
    <Container maxWidth={themeStretch ? false : 'xl'}>
      ...
      <Card sx={{ height: '72vh', display: 'flex' }}>
        <ChatNav ccData={ccData} conversations={conversations} activeConversationId={activeConversationId} />
