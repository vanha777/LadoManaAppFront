...
export default function BlogPostHero({ postData }) {
  const { post, profile } = postData;
    ...
    >
      ...
      <StyledFooter>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Avatar alt={profile.first_name} src={profile.avatar_url} sx={{ width: 48, height: 48 }} />
      ...
      <Image alt="cover" src={post.images[0]} ratio="16/9" />
    </Box>
  );
}
