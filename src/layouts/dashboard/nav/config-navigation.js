  ...
  // ----------------------------------------------------------------------
   {
    subheader: 'Thống Kê',
    items: [
      { title: 'Năng Xuất Hoạt Động', path: PATH_DASHBOARD.general.app, icon: ICONS.dashboard },
    ...
    items: [
...

      {
        ...
        children: [
          ...
          { title: 'Ghi Danh', path: PATH_DASHBOARD.user.new },
          { title: 'Sửa Đổi', path: PATH_DASHBOARD.user.demoEdit },
      ...
      /*  {
          ...
          children: [
            ...
            { title: 'my post', path: PATH_DASHBOARD.blog.demoView },
            { title: 'create posts', path: PATH_DASHBOARD.blog.new },
          ],
        },
      * {
           title: 'File manager',
